...
POSTS = {
 ...
 2013: [post("https://noic.com.br/uncategorized/resultados-da-3a-omcplp/", "Siaudzionis", "NOIC results post: 4 names + medals (Maputo)", domain="noic.com.br"),
        post("https://noic.com.br/matematica/comeca-a-olimpiada-matematica-da-lusofonia/", "Campos Vargas", "NOIC: team at the start (names, cities)", "full (pre-event roster)", domain="noic.com.br", timing="event")],
 ...
 2015: [post("https://noic.com.br/matematica/brasil-conquista-primeiro-lugar-na-olimpiada-de-matematica-da-cplp/", "Sponchiado", "NOIC results post: 4 names + medals; team champion (Praia)", domain="noic.com.br"),
        post("https://noic.com.br/matematica/divulgada-a-equipe-brasileira-para-a-olimpiada-de-matematica-da-cplp/", "Sponchiado", "NOIC team announcement", "full (pre-event roster)", domain="noic.com.br", timing="pre"),
 ...
 2017: [post("https://www.obm.org.br/2017/05/16/confira-a-equipe-que-participara-da-7a-omcplp/", "Koga", "OBM: team announcement (Porto, 24-30 Jul)", "full (pre-event roster)", timing="pre"),
 ...
 2019: [post("https://www.obm.org.br/2019/11/04/9a-olimpiada-de-matematica-dos-paises-da-cplp-comecou-neste-domingo-em-nova-friburgo/", "Lengruber", "OBM: team at the opening (full names, cities), leaders", "full (pre-event roster)", timing="event"),
        ...
        post("https://impa.br/notices/brasil-sedia-9a-omcplp-a-partir-de-domingo-3/", "Lengruber", "IMPA: team at the venue (full names)", "full (pre-event roster)", domain="impa.br", timing="pre")],
 ...
 2023: [post("https://www.obm.org.br/2023/05/28/com-dois-ouros-e-duas-pratas-brasil-fica-em-primeiro-lugar-na-omcplp/", "Fujibayashi", "OBM news: results table; team champion (Fortaleza)"),
        post("https://noic.com.br/uncategorized/times-luso-e-cone-sul-anunciados/", "Lucas Kenji", "NOIC team announcement (first-name short forms)", "full (pre-event roster)", domain="noic.com.br", timing="pre")],
