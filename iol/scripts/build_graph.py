#!/usr/bin/env python3
"""Build src/data/graph.json from data/raw/iol.json.
...
Raw record shape (data/raw/iol.json), a JSON list of:
  {"rawName": str, "olympiadId": "iol", "year": int,
...
def main():
    if not RAW.exists():
        sys.exit(f"missing {RAW}; create data/raw/iol.json first")
