...
def src(url, domain, cls, coverage, confirms, needle=None, timing="post", names=None):
    ...
    # cannot be fetched or parsed (social post, image) - curator attestation, read by
    # site/scripts/check_source_names.py as level "attested".
...
def obc(confirms="full roster + medals (organizer's História page)", timing="post"):
    return src(OBC_H, "obciencias.com.br (OBC/B8)", "primary", "full", confirms, timing=timing)


def olc(confirms, url=OLC, timing="post"):
    return src(url, "olimpiadascientificas.org", "archive", "full", confirms, timing=timing)


def wiki(confirms="roster + medals", url=PTWIKI, timing="post"):
    return src(url, "pt.wikipedia.org", "archive", "full", confirms, timing=timing)


SOURCES = {
 2004: [src("https://web.archive.org/web/2005/http://www.agencia.fapesp.br/boletim_dentro.php?id=2911",
            "agencia.fapesp.br (Wayback)", "primary", "full", "final traveling delegation — all 6 names + ages + schools (26/11/2004)", timing="pre"),
 ...
 2014: [obc("full roster + medals + leaders/observers"),
        src("http://www.obciencias.com.br/resultados-2014.html", "obciencias.com.br (OBC/B8)", "primary", "full",
            "selection list — exactly these 6 with schools/cities", timing="pre"),
 ...
 2016: [src("https://noic.com.br/uncategorized/brasil-conquista-4-ouros-e-melhor-resultado-da-historia-na-olimpiada-internacional-de-ciencias-junior-ijso/",
        ...
        src("https://web.archive.org/web/20161114153003/http://www.obciencias.com.br/resultados-2016.html",
            "obciencias.com.br (Wayback)", "primary", "full", "OBC 2016 gold medalists = the IJSO team (schools/cities)", timing="pre")],
 2017: [obc("'14.a IJSO' — full 6-name roster, all silver (final delegation)"),
        ...
        src("https://noic.com.br/uncategorized/divulgado-o-time-da-ijso-2017/", "noic.com.br", "primary", "5/6 — SUPERSEDED pre-event roster",
            "Oct 2017 announcement listed Ygor de Santana Moura; final delegation had Ricardo Sammuel instead", needle="Ygor", timing="pre")],
 2018: [obc("'15.a IJSO' — full roster, 4S+2B"),
        ...
        src("https://noic.com.br/interdisciplinares/veja-a-equipe-brasileira-na-ijso-2018/", "noic.com.br", "primary", "full",
            "pre-event roster — matches final delegation", timing="pre")],
 ...
 2021: [src("http://www.obciencias.com.br/resultados-2021.html", "obciencias.com.br (OBC/B8)", "primary", "full",
            "official convocados — all 6 names + seletiva ranks", timing="pre"),
        ...
        src("https://br.linkedin.com/in/mateus-augusto-cavassin", "linkedin.com", "primary", "1/6 — single source",
            ...
            names=["mateus-augusto-de-lara-cavassin"])],
 2022: [src("https://web.archive.org/web/20230321021334/https://www.ijso2022.com/ijso-2022/results",
        ...
        src("http://www.obciencias.com.br/resultados-2022.html", "obciencias.com.br (OBC/B8)", "primary", "full", "official convocados — same 6 names", timing="pre"),
 ...
 2023: [src("http://www.obciencias.com.br/resultados-2023.html", "obciencias.com.br (OBC/B8)", "primary", "full",
            "official convocados — 6 names + seletiva scores (ROSTER only; per-student medals unpublished)", timing="pre"),
        ...
        src("https://www.pm.ce.gov.br/2023/11/10/aluno-do-cpmce-gef-finalista-de-olimpiada-internacional-junior-de-ciencias-e-recebido-pelo-comando-da-pmce/",
            "pm.ce.gov.br", "primary", "1/6", "Sanzio Fechine selection/participation (gov.br-CE)", needle="Sanzio", timing="pre"),
 ...
 2024: [src("https://www.instagram.com/p/DDcZDoHRNMT/", "instagram.com/@obciencias (via imginn)", "primary", "full",
            ...
            names=["gabriel-mendes-freitas", "raul-saraiva-cavalcante"]),
        src("http://www.obciencias.com.br/resultados-2024.html", "obciencias.com.br (OBC/B8)", "primary", "full",
            "official convocados — 6 names + seletiva scores (page live but unlinked from menu)", timing="pre"),
        ...
        src("https://www.consed.org.br/noticia/olimpiada-brasileira-de-ciencias-levara-estudantes-brasileiros-para-competicao-internacional-na-romenia",
            "consed.org.br", "primary", "counts", "OBC→IJSO 2024 pipeline + dates (no names)", needle=None, timing="pre")],
}
...
ATTESTED = {
 2023: {"murilo-de-andrade-porfirio": "silver per direct communication from the Brazilian olympiad "
                                      "community, matching the official 0G/4S/1B country tally (see the year note)"},
}
...
def main():
    ...
    for r in records:
        ...
        for i, s in enumerate(r["sources"], 1):
            ...
            details.append(f"{i}. **{s['domain']}** ({s['cls']}, coverage: {s['coverage']}) — {s['url']} — {s['confirms']}{attests}")
        for pid, why in r.get("attested", {}).items():
            details.append(f"- attested (no URL): `{pid}` — {why}")
        if "note" in r:
            details.append(f"\n> {r['note']}")
        details.append("")
    detail_md = "\n".join(details)
