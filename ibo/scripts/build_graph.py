#!/usr/bin/env python3
"""Build src/data/graph.json from data/raw/ibo.json.
...
Raw record shape (data/raw/ibo.json), a JSON list of:
  {"rawName": str, "olympiadId": "ibo", "year": int,
...
def main():
    if not RAW.exists():
        sys.exit(f"missing {RAW}; create data/raw/ibo.json first")
