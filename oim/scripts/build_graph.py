#!/usr/bin/env python3
"""Build src/data/graph.json from data/raw/oim.json.
...
Raw record shape (data/raw/oim.json), a JSON list of:
  {"rawName": str, "olympiadId": "oim", "year": int,
...
def main():
    if not RAW.exists():
        sys.exit(f"missing {RAW}; create data/raw/oim.json first")
