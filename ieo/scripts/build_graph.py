#!/usr/bin/env python3
"""Build src/data/graph.json from data/raw/ieo.json.
...
Raw record shape (data/raw/ieo.json), a JSON list of:
  {"rawName": str, "olympiadId": "ieo", "year": int,
...
def main():
    if not RAW.exists():
        sys.exit(f"missing {RAW}; create data/raw/ieo.json first")
