#!/usr/bin/env python3
"""Build src/data/graph.json from data/raw/oii.json.
...
Raw record shape (data/raw/oii.json), a JSON list of:
  {"rawName": str, "olympiadId": "oii", "year": int,
...
def main():
    if not RAW.exists():
        sys.exit(f"missing {RAW}; create data/raw/oii.json first")
