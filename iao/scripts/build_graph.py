#!/usr/bin/env python3
"""Build src/data/graph.json from data/raw/iao.json.
...
Raw record shape (data/raw/iao.json), a JSON list of:
  {"rawName": str, "olympiadId": "iao", "year": int,
...
def main():
    if not RAW.exists():
        sys.exit(f"missing {RAW}; create data/raw/iao.json first")
