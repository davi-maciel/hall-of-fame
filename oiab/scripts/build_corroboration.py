...
def official(url, needle=None, confirms="official results sheet (oiab.org archive): names, scores and medals", coverage="full", domain=None, timing="post"):
    dom = domain or ("oiab.org" if "oiab.org" in url else "olimpiadadebiologia.edu.es")
    return src(url, dom, "official", coverage, confirms, needle, timing=timing)


def olc(needle, coverage="full", timing="post"):
    return src(OLC, "olimpiadascientificas.org", "primary", coverage, "olimpiadascientificas.org roster 2007-2017 (sources: OBB site, OIAB 2014 site)", needle, timing=timing)
...
def press(url, domain, needle, confirms, coverage="full", timing="post", names=None):
    return src(url, domain, "primary", coverage, confirms, needle, timing=timing, names=names)
...
SOURCES = {
 ...
 2009: [official(OEB + "2014/09/ResultadosOIAB-2009.pdf", None, "official score sheet (scanned image; read visually): 3 Brazilians, S+2B"), olc("Nunes Benevides"),
        src("https://servicos.aridesa.com.br/grandesconquistas/img/2018/07/olimp_ibero_americana_bio.jpg", "aridesa.com.br", "primary", "one student", "Ari de Sá poster: Rafael Lima Viana on the 2009 team (image)", timing="pre")],
 ...
 2014: [official(OEB + "2014/09/ResultadosOIAB-2014.pdf", "Voltani"), olc("Voltani"),
        ...
        noic("https://noic.com.br/biologia/divulgadas-equipes-brasileiras-da-ibo-e-oiab/", "Voltani", "NOIC team announcement", "full (pre-event roster)", timing="pre"),
 ...
 2015: [official(OEB + "2016/08/ResultadosOIAB-2015.pdf", "NATSUBORI", "official report + medal table: Brazil 3 silvers (Feitosa Viana, Natsubori Sato, Nogueira Filho) + 1 bronze"), olc("Natsubori"),
        ...
        noic("https://noic.com.br/biologia/divulgada-a-equipe-brasileira-da-ibo-e-da-oiab-2015/", "Natsubori", "NOIC team announcement", "full (pre-event roster)", timing="pre"),
        press("https://jornaldachapada.com.br/2015/09/03/brasil-busca-o-ouro-na-olimpiada-ibero-americana-de-biologia-em-el-salvador/", "jornaldachapada.com.br", "Natsubori", "pre-event roster with schools", "full (pre-event roster)", timing="pre")],
 2016: [official(OEB + "2016/09/resultados_oiab_2016_brasilia.jpg", None, "official ranking (photo of the results sheet; read visually): G + 2S + B", "image (full ranking)"), olc("Adamian"),
        noic("https://noic.com.br/uncategorized/divulgadas-as-equipes-brasileiras-nas-internacionais-de-biologia/", "Adamian", "NOIC team announcement", "full (pre-event roster)", timing="pre"),
 ...
 2017: [official("http://www.oiab.org/clasificacion_XI_oiab_2017_azores.pdf", "Helmich"), olc("Helmich"),
        noic("https://noic.com.br/biologia/divulgados-os-representantes-do-brasil-nas-internacionais-de-biologia/", "Helmich", "NOIC team announcement (lists Olavo Borges Franco, later replaced by João Victor Almeida Oliveira Santos)", "pre-event roster", timing="pre")],
 ...
 2022: [obb("20220705114103", "BRENO TAQUES", 2022),
        press("https://www.instagram.com/p/ClTWjOWNTJE/", "instagram.com", None,
              "IFCE Instagram, November 2022, POST-EVENT (caption pasted by the maintainer 2026-09-23; Instagram captions are not exposed to plain fetches): 'O estudante do curso técnico integrado em Química do campus de Fortaleza, Cícero Miguel Ângelo Neto, embarcou na última terça-feira (22/11) para São Paulo... Cícero Neto foi medalhista de ouro na Olimpíada Ibero-Americana de Biologia, na Olimpíada Brasileira de Biologia e 1º lugar da Regional Nordeste da Olimpíada Brasileira de Biotecnologia' - the institution's own confirmation of his OIAB gold",
              "one student: medal (post-event)", "post", ["cicero-miguel-angelo-neto"]),
        press("https://www.colegiosantoantonio.com.br/e-prata-aluna-do-csa-conquista-medalha-em-olimpiada-internacional/", "colegiosantoantonio.com.br",
              "medalha de prata na Olimpíada Ibero-americana de Biologia",
              "Colégio Santo Antônio (Belo Horizonte) news, 2022-09-14: 'Isabela Trad, aluna da 2ª Série do Ensino Médio do Colégio Santo Antônio, alcançou mais uma conquista e ganhou a medalha de prata na Olimpíada Ibero-americana de Biologia (OIAB), realizada na primeira semana de setembro, em Lima, Peru'",
              "one student"),
        ...
        press("https://bandnewsfmcuritiba.com/curitibano-e-bronze-na-olimpiada-ibero-americana-de-biologia/", "bandnewsfmcuritiba.com", "Breno Endres",
              "BandNews FM Curitiba, 2022-09-09 (results day): Breno Endres bronze at the XV OIAB, theory and practical papers on 6-7 Sep, ~40 contestants, and 'Os outros 3 alunos brasileiros são dos estados do Ceará, Pernambuco e Minas Gerais' (no medals given for them)",
              "one student + team origin"),
        press("https://bosquemananciais.org.br/index.php?area=ver_noticia&id=1234", "bosquemananciais.org.br", "Breno", "school news: Breno selected for the XV OIAB", "one student", timing="pre"),
 ...
 2026: [press("https://educacao.uol.com.br/noticias/2026/09/05/historico-brasil-ganha-4-ouros-na-olimpiada-ibero-americana-de-biologia.ghtm", "educacao.uol.com.br", "Heronville", "UOL Educação (host/organizer Butantan release): four golds with names and schools"),
        ...
        press("https://www.cnnbrasil.com.br/ciencia/brasil-e-representado-por-quatro-estudantes-na-19a-olimpiada-ibero-americana/", "cnnbrasil.com.br", "Daltro", "CNN Brasil: team at the opening (roster)", "full (pre-event roster)", timing="event"),
...
NOTES = {
 ...
 2022: "Remote edition (Peru, 5-9 Sep; results announced Friday 9 Sep). No results file exists: oiab.org's 2022 section holds only the programme and the leaders list, Spain's OEB posted no memoir, and Butantan - unlike every other edition from 2018 on - published no results release at all (no such page in the Wayback record; its site is additionally offline under the 2026 electoral blackout). Team from the OBB selection list; the three documented medals were each reconstructed from the student's own institution or local press: Cícero Miguel Ângelo Neto gold (IFCE's Instagram, Nov 2022), Isabela Trad Timo Luz silver (her school's 2022-09-14 news) and Breno Taques Mussi Endres bronze (Curitiba city hall, BandNews FM, school, UFPR). Artur Neves Maia is the only award still unknown - null with medalStatus; Wikipedia's cumulative medal table would put a silver there, but nothing states it. Name: the OBB seletiva list writes 'Arthur', but OBQ/OBF/OBM/OBMEP/ONC annals and the April 2022 Recife press all print 'Artur Neves Maia' - the dataset follows Artur (slugAlias keeps the arthur- slug).",
